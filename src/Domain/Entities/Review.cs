...
/// <summary>
/// Review tags for categorizing reviews
/// </summary>
public class ReviewTag
{
    ...
    [Required]
    [MaxLength(50)]
    public string Tag { get; set; } = string.Empty; // "Food Quality", "Delivery Speed", "Service", etc.
    
    public bool IsPositive { get; set; } = true; // Positive or negative tag
