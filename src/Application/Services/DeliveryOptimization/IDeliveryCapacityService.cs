...
public interface IDeliveryCapacityService
{
    ...
    /// </summary>
    Task<Result<DeliveryCapacityResponse>> CreateCapacityAsync(
    ...
    /// </summary>
    Task<Result<DeliveryCapacityResponse>> UpdateCapacityAsync(
        Guid capacityId,
        DeliveryCapacityRequest request,
        CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<Result<DeliveryCapacityCheckResponse>> CheckCapacityAsync(
    ...
    /// </summary>
    Task<Result> IncrementActiveDeliveriesAsync(
        Guid merchantId,
    ...
    /// </summary>
    Task<Result> DecrementActiveDeliveriesAsync(
        Guid merchantId,
        Guid? deliveryZoneId = null,
        CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<Result> IncrementDailyDeliveriesAsync(
        Guid merchantId,
        Guid? deliveryZoneId = null,
        CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<Result<DeliveryCapacityResponse>> GetCapacityAsync(
        Guid merchantId,
        Guid? deliveryZoneId = null,
        CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<Result> AdjustCapacityAsync(
    ...
    /// </summary>
    Task<Result> SendCapacityAlertAsync(
    ...
    /// </summary>
    Task<Result> ResetDailyCountersAsync(
        CancellationToken cancellationToken = default);

    /// <summary>
    /// Haftalık kapasite sayaçlarını sıfırlar
    /// </summary>
    Task<Result> ResetWeeklyCountersAsync(
        CancellationToken cancellationToken = default);
}
