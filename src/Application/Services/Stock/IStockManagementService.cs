...
public interface IStockManagementService
{
    ...
    /// </summary>
    Task<Result> ReduceStockForOrderAsync(
        Guid orderId,
    ...
    /// </summary>
    Task<Result> RestoreStockForOrderAsync(
        Guid orderId,
        CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<Result> CheckStockLevelsAndAlertAsync(
        Guid merchantId,
        CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<Result<List<StockHistoryResponse>>> GetStockHistoryAsync(
        Guid productId,
    ...
    /// </summary>
    Task<Result<List<StockAlertResponse>>> GetStockAlertsAsync(
        Guid merchantId,
        CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<Result> UpdateStockLevelAsync(
    ...
    /// </summary>
    Task<Result> BulkUpdateStockLevelsAsync(
    ...
    /// Gets stock reports
    /// </summary>
    Task<Result<StockReportResponse>> GetStockReportAsync(
    ...
    /// </summary>
    Task<Result> SynchronizeStockAsync(
        Guid merchantId,
        CancellationToken cancellationToken = default);
}
