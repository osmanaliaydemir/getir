...
public interface IStockAlertService
{
    ...
    /// </summary>
    Task<Result> CreateLowStockAlertsAsync(
        Guid merchantId,
    ...
    /// </summary>
    Task<Result> CreateOutOfStockAlertsAsync(
        Guid merchantId,
        CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<Result> CreateOverstockAlertsAsync(
        Guid merchantId,
        CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<Result> ResolveStockAlertAsync(
        Guid alertId,
        Guid resolvedBy,
    ...
    /// </summary>
    Task<Result<StockAlertStatisticsResponse>> GetStockAlertStatisticsAsync(
        Guid merchantId,
    ...
    /// </summary>
    Task<Result> SendStockAlertNotificationsAsync(
        List<Guid> alertIds,
        CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<Result> ConfigureStockAlertSettingsAsync(
