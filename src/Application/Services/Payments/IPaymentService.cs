...
public interface IPaymentService
{
    ...
    /// <summary>
    /// Merchant ödeme geçmişini getir (tüm ödeme yöntemleri)
    /// </summary>
    Task<Result<PagedResult<PaymentResponse>>> GetMerchantPaymentsAsync(Guid merchantId, PaginationQuery query, DateTime? startDate = null, DateTime? endDate = null, PaymentMethod? paymentMethod = null, PaymentStatus? status = null, CancellationToken cancellationToken = default);
