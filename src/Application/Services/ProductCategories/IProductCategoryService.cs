...
public interface IProductCategoryService
{
    ...
    Task<Result<ProductCategoryResponse>> GetProductCategoryByIdAsync(
        Guid id,
        CancellationToken cancellationToken = default);
    ...
    Task<Result<ProductCategoryResponse>> UpdateProductCategoryAsync(
        Guid id,
        UpdateProductCategoryRequest request,
        Guid currentUserId,
        CancellationToken cancellationToken = default);
    
    Task<Result> DeleteProductCategoryAsync(
        Guid id,
        Guid currentUserId,
        CancellationToken cancellationToken = default);
}
