...
public interface IUserPreferencesService
{
    ...
    Task<Result<UserNotificationPreferencesResponse>> GetUserPreferencesAsync(
        Guid userId,
    ...
    Task<Result<UserNotificationPreferencesResponse>> GetOrCreateUserPreferencesAsync(
        Guid userId,
        CancellationToken cancellationToken = default);
    ...
    Task<Result<UserNotificationPreferencesResponse>> UpdateUserPreferencesAsync(
        Guid userId,
    ...
    Task<Result<MerchantNotificationPreferencesResponse>> GetMerchantPreferencesAsync(
        Guid userId,
        CancellationToken cancellationToken = default);
    ...
    Task<Result<MerchantNotificationPreferencesResponse>> UpdateMerchantPreferencesAsync(
        Guid userId,
    ...
    /// <param name="userId">User ID</param>
    /// <param name="cancellationToken">Cancellation token</param>
    Task<Result> DeleteUserPreferencesAsync(
        Guid userId,
        CancellationToken cancellationToken = default);
}
