...
class GeneratedLocalizationsAr extends GeneratedLocalizations {
  ...
  @override
  String get emptyCartMessage => 'ابدأ التسوق لإضافة منتجات إلى سلتك';
  ...
  String get removeItemMessage =>
      'هل أنت متأكد أنك تريد إزالة هذا المنتج من سلتك؟';
  ...
  String get clearCartMessage =>
      'هل أنت متأكد أنك تريد إزالة جميع المنتجات من سلتك؟';
  ...
  @override
  String get nutritionalInfo => 'القيم الغذائية';
