...
class AuthRepositoryImpl implements AuthRepository {
  ...
  Future<UserEntity> login(String email, String password) async {
    try {
      ...
      await _dataSource.saveCurrentUser(response.user);
  ...
  @override
  Future<UserEntity> register(String email, String password, String firstName, String lastName, {String? phoneNumber}) async {
    try {
