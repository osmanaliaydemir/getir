...
// in getir_mobile/test/integration/order_flow_test.dart.
...
import 'package:getir_mobile/presentation/bloc/merchant/merchant_bloc.dart'
    as _i5;
import 'package:getir_mobile/presentation/bloc/order/order_bloc.dart' as _i3;
...
class _FakeAddressState_2 extends _i1.SmartFake implements _i4.AddressState {
  _FakeAddressState_2(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
///
/// See the documentation for Mockito's code generation for more information.
class MockOrderBloc extends _i1.Mock implements _i3.OrderBloc {
  MockOrderBloc() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.OrderState get state => (super.noSuchMethod(
        Invocation.getter(#state),
        returnValue: _FakeOrderState_1(
          this,
          Invocation.getter(#state),
        ),
      ) as _i3.OrderState);
  ...
  @override
  _i7.Stream<_i3.OrderState> get stream => (super.noSuchMethod(
        Invocation.getter(#stream),
        returnValue: _i7.Stream<_i3.OrderState>.empty(),
      ) as _i7.Stream<_i3.OrderState>);
  ...
  @override
  void add(_i3.OrderEvent? event) => super.noSuchMethod(
        Invocation.method(
          #add,
          [event],
        ),
  ...
  @override
  void onEvent(_i3.OrderEvent? event) => super.noSuchMethod(
        Invocation.method(
          #onEvent,
          [event],
        ),
  ...
  @override
  void on<E extends _i3.OrderEvent>(
    _i8.EventHandler<E, _i3.OrderState>? handler, {
    _i8.EventTransformer<E>? transformer,
  }) =>
      super.noSuchMethod(
        Invocation.method(
  ...
  @override
  void onTransition(
          _i8.Transition<_i3.OrderEvent, _i3.OrderState>? transition) =>
      super.noSuchMethod(
        Invocation.method(
          #onTransition,
          [transition],
  ...
  @override
  void onChange(_i8.Change<_i3.OrderState>? change) => super.noSuchMethod(
        Invocation.method(
          #onChange,
          [change],
        ),
...
///
/// See the documentation for Mockito's code generation for more information.
class MockAddressBloc extends _i1.Mock implements _i4.AddressBloc {
  MockAddressBloc() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.AddressState get state => (super.noSuchMethod(
        Invocation.getter(#state),
        returnValue: _FakeAddressState_2(
          this,
          Invocation.getter(#state),
        ),
      ) as _i4.AddressState);
  ...
  @override
  _i7.Stream<_i4.AddressState> get stream => (super.noSuchMethod(
        Invocation.getter(#stream),
        returnValue: _i7.Stream<_i4.AddressState>.empty(),
      ) as _i7.Stream<_i4.AddressState>);
  ...
  @override
  void add(_i4.AddressEvent? event) => super.noSuchMethod(
        Invocation.method(
          #add,
          [event],
        ),
  ...
  @override
  void onEvent(_i4.AddressEvent? event) => super.noSuchMethod(
        Invocation.method(
          #onEvent,
          [event],
        ),
  ...
  @override
  void emit(_i4.AddressState? state) => super.noSuchMethod(
        Invocation.method(
          #emit,
          [state],
        ),
  ...
  @override
  void on<E extends _i4.AddressEvent>(
    _i8.EventHandler<E, _i4.AddressState>? handler, {
    _i8.EventTransformer<E>? transformer,
  }) =>
      super.noSuchMethod(
        Invocation.method(
  ...
  @override
  void onTransition(
          _i8.Transition<_i4.AddressEvent, _i4.AddressState>? transition) =>
      super.noSuchMethod(
        Invocation.method(
          #onTransition,
          [transition],
  ...
  @override
  void onChange(_i8.Change<_i4.AddressState>? change) => super.noSuchMethod(
        Invocation.method(
          #onChange,
          [change],
        ),
